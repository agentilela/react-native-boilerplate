...
declare module 'mobx-react' {
  ...
  export function inject<K extends keyof IStores>(
    ...stores: K[]
  ): <P extends { [name in K]: IStores[K] }>(
    component: React.ComponentType<P>
  ) => React.ComponentType<ObjectOmit<P, K>>

  export function inject<T>(
    mapStoreToProps: (store: { store: IRootStore }) => T
  ): <P extends T>(component: React.ComponentType<P>) => React.ComponentType<ObjectOmit<P, keyof T>>

  export class Observer extends React.Component<
    { children?(): null | React.ReactElement<any> | (null | React.ReactElement<any>)[] },
    {}
  > {}
